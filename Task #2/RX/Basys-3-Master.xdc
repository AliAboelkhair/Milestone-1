...
set_property PACKAGE_PIN E19 [get_ports {tx_active_led}]
...
#set_property PACKAGE_PIN T18 [get_ports move_car_2_up]
#	set_property IOSTANDARD LVCMOS33 [get_ports move_car_2_up]
#set_property PACKAGE_PIN W19 [get_ports move_car_2_left]
#	set_property IOSTANDARD LVCMOS33 [get_ports move_car_2_left]
#set_property PACKAGE_PIN T17 [get_ports move_car_2_right]
#	set_property IOSTANDARD LVCMOS33 [get_ports move_car_2_right]
#set_property PACKAGE_PIN U17 [get_ports move_car_2_down]
#	set_property IOSTANDARD LVCMOS33 [get_ports move_car_2_down]



##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {Rx_serial}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Rx_serial}]
##Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {JA[1]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {JA[1]}]
##Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {tx_uart_serial}]
	set_property IOSTANDARD LVCMOS33 [get_ports {tx_uart_serial}]
##Sch name = JA4
